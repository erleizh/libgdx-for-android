...
import com.erlei.gdx.assets.loaders.MusicLoader;
...
import com.erlei.gdx.assets.loaders.SkinLoader;
import com.erlei.gdx.assets.loaders.SoundLoader;
...
import com.erlei.gdx.audio.Music;
import com.erlei.gdx.audio.Sound;
...
import com.erlei.gdx.scenes.scene2d.ui.Skin;
...
public class AssetManager implements Disposable {
	...
	public AssetManager (FileHandleResolver resolver, boolean defaultLoaders) {
		...
		if (defaultLoaders) {
			...
			setLoader(com.erlei.gdx.graphics.g3d.particles.ParticleEffect.class,
				new com.erlei.gdx.graphics.g3d.particles.ParticleEffectLoader(resolver));
