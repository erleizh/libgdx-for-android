...
import com.erlei.gdx.input.GestureDetector;
import com.erlei.gdx.input.GestureDetector.GestureAdapter;
import com.erlei.gdx.math.Vector2;
import com.erlei.gdx.scenes.scene2d.Actor;
import com.erlei.gdx.scenes.scene2d.Event;
import com.erlei.gdx.scenes.scene2d.EventListener;
...
public class ActorGestureListener implements EventListener {
	...
	/** @see GestureDetector#GestureDetector(com.erlei.gdx.input.GestureDetector.GestureListener) */
	public ActorGestureListener () {
		this(20, 0.4f, 1.1f, 0.15f);
	}

	/** @see GestureDetector#GestureDetector(float, float, float, float, com.erlei.gdx.input.GestureDetector.GestureListener) */
