...
public class IndexBufferObjectSubData implements IndexData {
    ...
    private int createBufferObject() {
        int result = GLContext.getGL20().glGenBuffer();
        GLContext.getGL20().glBindBuffer(GL20.GL_ELEMENT_ARRAY_BUFFER, result);
        GLContext.getGL20().glBufferData(GL20.GL_ELEMENT_ARRAY_BUFFER, byteBuffer.capacity(), null, usage);
        GLContext.getGL20().glBindBuffer(GL20.GL_ELEMENT_ARRAY_BUFFER, 0);
        return result;
    }
    ...
    public void setIndices(short[] indices, int offset, int count) {
        ...
        if (isBound) {
            GLContext.getGL20().glBufferSubData(GL20.GL_ELEMENT_ARRAY_BUFFER, 0, byteBuffer.limit(), byteBuffer);
            isDirty = false;
        }
    }
    ...
    public void bind() {
        ...
        GLContext.getGL20().glBindBuffer(GL20.GL_ELEMENT_ARRAY_BUFFER, bufferHandle);
        if (isDirty) {
