...
public class VideoRecorderHandler extends Handler {
     ...
     * @see VideoRecorderHandler#handleMediaCaptureStarted(String)
     */
     ...
     *
     * @param output 本次录制的视频文件路径
     * @see VideoRecorderHandler#handleMediaCaptureStopped(String)
     */
     ...
     * @see VideoRecorderHandler#handleVideoMuxerStopped(String)
     */
     ...
     *               导致接收不到VideoRecorderHandler.MSG_MEDIA_MUXER_START
     *               消息 , 导致没有调用 handleVideoMuxerStarted()
     * @see VideoRecorderHandler#handleVideoMuxerStarted(String)
     */
