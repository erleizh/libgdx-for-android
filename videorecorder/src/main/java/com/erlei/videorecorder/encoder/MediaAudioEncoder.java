...
public class MediaAudioEncoder extends MediaEncoder {
    ...
    protected void prepare() throws IOException {
        ...
        mLogger.info("selected codec: " + audioCodecInfo.getName());
        ...
        mLogger.info("format: " + audioFormat);
        ...
        public void run() {
            ...
            try {
                ...
                if (audioRecord != null) {
                    try {
                        if (mIsCapturing) {
                            mLogger.debug("AudioThread:start audio recording");
                    ...
                    mLogger.error("failed to initialize AudioRecord");
                }
            } catch (final Exception e) {
                mLogger.error("AudioThread#run", e);
            }
            mLogger.debug("AudioThread:finished");
        }
    }
