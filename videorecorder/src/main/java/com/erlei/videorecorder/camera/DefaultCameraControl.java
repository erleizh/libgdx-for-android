...
public class DefaultCameraControl implements CameraControl {

    private Logger mLogger = new Logger("CameraControl");

    protected final Context mContext;
    private final IRenderView mCameraPreview;
    ...
    public DefaultCameraControl(IRenderView cameraPreview) {
    ...
    public Size getCameraSize() {
        return mCamera == null ? new Size(0, 0) : mCamera.getFixedPreviewSize();
    }


    @Override
    public Size getSurfaceSize() {
        return mSurfaceSize.set(mCameraPreview.getSurfaceWidth(), mCameraPreview.getSurfaceHeight());
    }

    @Override
    public synchronized boolean open(SurfaceTexture texture) {
        ...
        mLogger.debug("openCamera " + System.currentTimeMillis());
        return mCamera != null;
    }
